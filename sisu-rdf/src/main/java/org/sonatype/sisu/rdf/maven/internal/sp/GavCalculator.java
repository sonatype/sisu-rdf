...
public class GavCalculator
{
    ...
    public static Gav pathToGav( String str )
    {
        try
        {
    ...
    private static Gav getReleaseGav( String s, int vEndPos, String groupId, String artifactId, String version,
    ...
    private static Gav getSnapshotGav( String s, int vEndPos, String groupId, String artifactId, String version,
                                       String fileName, boolean checksum, boolean signature, Gav.HashType checksumType,
                                       Gav.SignatureType signatureType )
    {
    ...
    public static String gavToPath( Gav gav )
    {
